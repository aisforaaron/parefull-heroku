                ...
                <div className="col-md-12 text-center">
                    <div className="btn-group">
                        <label className="btn btn-default center-block bit-add">
                            <a href="#add"><img src="http://placehold.it/200x50/4E8975/fff?text=Add+a+Bit"
                                                className="img-responsive"/></a>
                        </label>
                        <label className="btn btn-default center-block bit-score">
                            <a href="#score"><img src="http://placehold.it/200x50/8A4E62/fff?text=Score+A+Bit"
                                                  className="img-responsive"/></a>
                        </label>
                        <label className="btn btn-default center-block bit-refresh">
                            <a href="#"><img src="http://placehold.it/200x50/8A764E/fff?text=Compare+Bits!"
                                             className="img-responsive"/></a>
                        </label>
                    </div>
                </div>
            ...
            <div className="comparebox" ref="comparebox">
                ...
                <div className="row bits-and-arrow">
                    <div className="col-md-4 text-center">
                        <BitBox bitName={this.state.bitName} bitAvg={this.state.bitAvg} bitImg={this.state.bitImg}
                                bitId={this.state.bitId} bitKey="left"/>
                    </div>
                    <div className="col-md-4 text-center arrow-text">
                        <div className="arrow">{this.state.arrow}</div>
                    </div>
                    <div className="col-md-4 text-center">
                        <BitBox bitName={this.state.bitName2} bitAvg={this.state.bitAvg2} bitImg={this.state.bitImg2}
                                bitId={this.state.bitId2} bitKey="right"/>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="bitbox-outer">
                <div className="row bitbox">
                    <div className="col-md-12 text-center bit-img">
                        <img width="100" height="100" onError={this.swapImgOnError} id={this.props.bitKey}
                             src={this.props.bitImg}/>
                    </div>
