...
module.exports = {
  ...
  getSetCache: function (name, id, cb) {
    // console.log('getSetCache start, id '+id)
    var self = this
    var bitImg = ''
                    ...
                    if(res) { 
                      ...
                      superagent
                        ...
                        .end(function (err, result) {
                          if(err) throw err;
                          // console.log('---end-getSetCache--> updated bit image '+imgName)
                          return cb(null, imgName) // return image name
                      }); // end id/id
                    } 
                  }); // end cacheGoogleImage
              // }); // end getCachedImagePath
